    ...
    var body: some View {
        ...
        .sheet(isPresented: $isShowingInfo) {
            NudgeInfoSheet(
                ...
                nudgeInstalled: $nudgeInstalled,
                nudgeVersion: $nudgeVersion,
                nudgePath: $nudgePath,
                latestNudgeVersion: $latestNudgeVersion,
                latestNudgeError: $latestNudgeError,
                latestSuiteURL: $latestSuiteURL,
                latestSuiteError: $latestSuiteError,
                detectionLog: $nudgeDetectionLog,
                isFetchingLatestNudge: $isFetchingLatestNudge,
                onRefreshStatus: refreshNudgeInfo,
                onFetchLatestVersion: fetchLatestNudgeVersion,
                onFetchSuiteURL: fetchLatestSuiteURL
            )
        }
